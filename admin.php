                                ...
                                <div class="card-body ">
                                  ...
                                  <select id ="lokasiData"style="margin-top:30px;" class="form-control" name="" onchange="fungsitest()">
                                    ...
                                    <?php
                                     ...
                                     while ($i<$panjang)
                                     {
                                        echo "<option label='".$data[$i]['name']."' value='".$data[$i]['id_upload']."'>"."</option>";
                                        $i++;
                                     }
...
function fungsitest()
{
  ...
  swal("Tandai sebagai daerah yang telah selesai di bersihkan");
  document.getElementById("textSaya").innerHTML=daerah;
...
function tandaiSelesai()
{
  ...
  text: "Dengan mengklik Ok berarti daerah yang ditunjuk akan ditandai sudah ditindaklanjuti!",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
.then((willDelete) => {
  if (willDelete) {
    window.location="proses/tandaimarker.php?id="+daerah;
